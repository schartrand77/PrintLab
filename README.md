...
- PrintLab Slicer:
  `ORCASLICER_BINARY` points to the OrcaSlicer executable used by `/slicer`. If unset, PrintLab checks PATH and common install locations. `ORCA_SLICER_BINARY` is supported as a legacy alias.
